      ...
      <Box rounded="md">
        ...
        <FormWrapper onSubmit={formik.handleSubmit}>
          <NumberInput
            ...
            formControlProps={{
              id: 'task_completed',
              isInvalid: !!formik.errors?.task_completed,
            }}
            name="task_completed"
            error={formik.errors?.task_completed}
            value={formik.values?.task_completed}
            onChange={(valueString, valueNumber) =>
              formik.setFieldValue('task_completed', Number.isNaN(valueNumber) ? 0 : valueNumber)
            }
          />
          ...
          <NumberInput
            ...
            formControlProps={{
              id: 'task_total',
              isInvalid: !!formik.errors?.task_total,
            }}
            name="task_total"
            error={formik.errors?.task_total}
            value={formik.values?.task_total}
            onChange={(valueString, valueNumber) =>
              formik.setFieldValue('task_total', Number.isNaN(valueNumber) ? 0 : valueNumber)
            }
          />
