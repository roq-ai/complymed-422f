...
export function ProgressListPage(props: ProgressListPageProps) {
  ...
  const { data, error, isLoading, mutate } = useSWR<PaginatedInterface<ProgressInterface>>(
    () => `/progresses?params=${JSON.stringify(params)}`,
    fetcher,
  );
  ...
  const columns: ColumnType[] = [
    { id: 'task_completed', header: 'task_completed', accessorKey: 'task_completed' },
    { id: 'task_total', header: 'task_total', accessorKey: 'task_total' },
